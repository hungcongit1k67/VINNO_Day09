...
- **Thiết kế:** Mock Python class (Standard level) — dễ swap sang HTTP server thật
...
| Avg latency (sau warm-up) | ~20 ms |
| Tài liệu được truy cập | 5/5 documents |
